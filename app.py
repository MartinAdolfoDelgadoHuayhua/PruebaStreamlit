...
if grupos_file and datos_file:
    try:
        ...
        user_df = user_df[user_df['PUESTO REQUERIDO'].isin(['ASESOR DE NEGOCIOS 2', 'ASESOR DE NEGOCIOS 1','ASESOR DE NEGOCIOS 3','ASESOR DE NEGOCIOS  3  ','ASESOR DE NEGOCIOS  1  ',
       'ASESOR DE NEGOCIOS  SENIOR', 'ASESOR DE NEGOCIOS  2  ']).reset_index(drop=True)
